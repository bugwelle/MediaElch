...
{
public:
    ~MovieRenamerPlaceholders() override = default;
...
{
public:
    explicit MovieRenamerData(Movie& m_movie) : m_movie(m_movie) {}
    ~MovieRenamerData() override = default;
    ...
    ELCH_NODISCARD QString value(const QString& name) const override
    {
        ...
        MediaElch_Debug_Assert("MovieRenamerData::value: Unknown tag");
        return "";
    }
